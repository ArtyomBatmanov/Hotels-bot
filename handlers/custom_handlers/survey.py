...
def get_city(message):
    bot.send_message(message.from_user.id, 'Cпасибо, записал. Теперь отправь свой номер нажав на кнопку',
...
def get_contact(message):
    if message.content_type == 'contact':
        ...
        text = f'Спасибо за предоставленную инфомацию ваши данные:\n' \
               f'Имя:{data["name"]}\n' \
               f'Возраст: {data["age"]}\n' \
